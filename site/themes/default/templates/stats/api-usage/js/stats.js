...
//                        currentDay = new Date(d.getFullYear(), d.getMonth(), d.getDate()+1,d.getHours(),d.getMinutes());
//                    }
    ...
    jagg.post("/site/blocks/stats/api-usage/ajax/stats.jag", { action:"getProviderAPIUsage",currentLocation:currentLocation,fromDate:fromDate,toDate:toDate  },
        function (json) {
            if (!json.error) {
                ...
                //var $dataTable =$('<table class="table tablesorter graphTable" id="apiTable"></table>');
