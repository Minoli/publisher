...
//                    $("#rangeSliderWrapper").width(width);
                    ...
                    $('#date-range').dateRangePicker(
                        ...
                        {
                         var d1=Date.parse(obj.date1)
                         var from = convertTimeString(d1);
                         var d2=Date.parse(obj.date2)
                         var to = convertTimeString(d2);
                         drawAPIUsageByResourcePath(from, to);
                         clicked4=true;
                        })
...
//var data=[
//             {
//                 "creat_time": "2014-10-03 10:23:00",
//                 "roundTripTime": 106
//             },
//             {
//                 "creat_time": "2014-11-28 09:02:00",
//                 "roundTripTime": 5
//             },
//             {
//                 "creat_time": "2014-11-28 09:05:00",
//                 "roundTripTime": 50
//             },
//             {
//                 "creat_time": "2014-11-28 09:03:00",
//                 "roundTripTime": 183
//             },
//             {
//                 "creat_time": "2014-11-28 09:07:00",
//                 "roundTripTime": 15
//             }
//         ];
...
//     },
//     {
//         "creat_time": "2014-11-28 09:06:00",
//         "roundTripTime": 50
//     },
//     {
//         "creat_time": "2014-11-28 09:34:00",
//         "roundTripTime": 183
//     },
//     {
//         "creat_time": "2014-11-28 09:56:00",
//         "roundTripTime": 15
//     }
//];
//
...
//
//
//                        var svg = d3.select("body #testdiv")
//                            .append("svg")
...
//                    $dataTable.append($('<tr><td>' + json.usage[i].apiName + '</td><td>' + json.usage[i].version + '</td><td>' + json.usage[i].context + '</td><td>' + json.usage[i].method + '</td><td class="tdNumberCell">' + json.usage[i].count +"   "+ json.usage[i].time+'</td></tr>'));
//                }
                if (length == 0) {
